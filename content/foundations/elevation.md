---
title: Elevation
description: Box shadow elevation tokens from the Scribe design system scale.
...
- **Main**: default cards, panels, and chrome at rest.
- **Overlay**: menus, popovers, dialogs, and other floating layers above the page.
- **Reverse overlay**: elements anchored along the bottom edge that need an upward shadow.
