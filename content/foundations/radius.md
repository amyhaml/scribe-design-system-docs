---
title: Radius
description: Border radius tokens from the Scribe design system scale.
...
- **None (0px)**: full-bleed surfaces and deliberately sharp edges.
- **Small (4px)**: inputs, buttons, chips, and compact toolbar tiles.
- **Medium (8px)**: cards, menus, popovers, and dialogs.
- **Large (12px)**: hero cards and larger panels.
