...
import { checkboxDemos } from "@/components/docs/demos/checkbox-demos";
...
const doc = getDoc("components/checkbox");
    ...
    meta: [
      { title: `${doc.frontmatter.title} - Scribe` },
      {
        ...
        content:
          ...
          "Scribe Checkbox documentation for selection controls.",
      },
    ],
  }),
...
function CheckboxDocsPage() {
  const figmaUrl = getFigmaUrlForDocSlug("checkbox");
  ...
  return (
    <DocsShell
      ...
      toc={toc}
    >
      <DocPageSections sections={doc.sections} demos={checkboxDemos} toc={doc.frontmatter.toc} />
    </DocsShell>
  );
}
