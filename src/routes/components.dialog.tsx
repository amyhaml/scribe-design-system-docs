...
import { dialogDemos } from "@/components/docs/demos/dialog-demos";
...
const doc = getDoc("components/dialog");
    ...
    meta: [
      { title: `${doc.frontmatter.title} - Scribe` },
      {
        ...
        content:
          ...
          "Scribe Dialog documentation for confirmation and publishing workflows.",
      },
    ],
  }),
...
function DialogDocsPage() {
  const figmaUrl = getFigmaUrlForDocSlug("dialog");
  ...
  return (
    <DocsShell
      ...
      toc={toc}
    >
      <DocPageSections sections={doc.sections} demos={dialogDemos} toc={doc.frontmatter.toc} />
    </DocsShell>
  );
}
